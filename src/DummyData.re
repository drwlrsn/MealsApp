...
let _categories = [|
  ...
  ("c3", {id: "c2", title: "Quck & Easy", color: "#f54242"}),
  ...
  ("c6", {id: "c8", title: "Asian", color: "#b9ffb0"}),
  ("c9", {id: "c9", title: "French", color: "#ffc7ff"}),
  ("c10", {id: "c10", title: "Summer", color: "#47fced"}),
|];

let categories = Belt.Map.String.fromArray(_categories);

let _meals: array((string, meal)) = [|
  (
    "m1",
    {
      id: "m1",
...
let meals = Belt.Map.String.fromArray(_meals);